...
app.get('/api/health', (req, res) => {
  res.json({
    ...
    service: 'Finance API - Transacciones',
    version: '1.1.0',
  });
});
  ...
  try {
    ...
    if (walletCount === 0) {
      ...
      const initialWallets = [
        { name: 'Cuenta Bancaria USD', type: 'bank', currency: 'USD', balance: 0, description: 'Cuenta bancaria en dólares' },
        { name: 'Cuenta Bancaria VES', type: 'bank', currency: 'VES', balance: 0, description: 'Cuenta bancaria en bolívares' },
        { name: 'Efectivo USD', type: 'cash', currency: 'USD',balance: 0, description: 'Efectivo en dólares' },
        { name: 'Efectivo VES', type: 'cash', currency: 'VES', balance: 0, description: 'Efectivo en bolívares' },
        { name: 'Crypto Wallet', type: 'crypto', currency: 'USD', balance: 0, description: 'Wallet de criptomonedas (Binance, etc.)' },
        { name: 'Tarjeta Prepagada', type: 'card', currency: 'USD', balance: 0, description: 'Tarjeta prepagada internacional' },
      ];
...
async function startServer() {
  ...
  app.listen(port, () => {
    ...
    console.log('\n✨ Servidor listo con transacciones activas.');
    console.log('📝 Transacciones actualizan balances automáticamente.');
